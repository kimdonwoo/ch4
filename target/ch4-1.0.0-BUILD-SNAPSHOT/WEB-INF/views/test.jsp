...
<script>
  ...
  let showList = function(bno){
    $.ajax({
      ...
      success : function(result){
        $("#commentList").html(toHTML(result));    // 댓글목록 가져온걸 id commentList에 넣음
      },
  ...
  $(document).ready(function(){
    ...
    //$(".delBtn").click(function(){ 이건 x
    // commentList안에 있는 delBtn 클래스에다가 click 이벤트 거는 것
    // 동적으로 생성되는 요소 이벤트 거는 방법
